# Knee Slide to Leg Attack Entry

## Overview
A cooperative technical drill from top half guard where the top player practices sliding their outside knee across the opponent's belt line, underhooking the top leg, and pivoting to arrive facing the legs in a leg attack configuration. The bottom player holds a passive knee shield and provides a consistent body position - no resistance.
...
**Objective:** Hold the knee shield shape without active resistance, allowing your partner to drill the entry repeatedly  

## Instructions
1. Top player starts in top half guard, bottom player holds a passive knee shield
2. Top player uses bodyweight to press through the knee shield and flatten it
...
## Coaching Points
For top player:
- Use bodyweight to flatten the knee shield before sliding - drive the weight through, don't yank
- Keep your hips low as you slide the outside knee across the belt line
