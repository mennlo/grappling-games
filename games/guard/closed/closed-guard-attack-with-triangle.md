# Closed Guard Attack with Triangle

## Overview
A closed guard drill where the bottom player works to establish multiple offensive control positions including the triangle finish, while the top player defends and maintains posture or starts passing.
...
2. Bottom player works to achieve any of the four win conditions:
   ...
   - Get your leg over their shoulder for a triangle finish
...
- For the triangle, break posture first and then work to get your leg over the shoulder
...
- Keep one arm in and one arm out to prevent triangle setups
